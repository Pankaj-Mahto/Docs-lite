...
//       {/* ✅ SAVE BUTTON FIXED ON TOP RIGHT */}
//       <Header documentTitle={documentTitle} onSave={saveNow} />


//       {/* ✅ ACTIVE USERS WITH COLOR */}
...
//       {/* ✅ COLLAPSIBLE LOG PANEL (BOTTOM RIGHT) */}
...
//             {changeLogs.map((l, i) => (
//               <div key={i}>
//                 <span style={{ color: stringToColor(l.user) }}>{l.user}</span>
//                 {" edited at "}
//                 {l.time}
//               </div>
//             ))}
    ...
    File: [
      {
        label: "New",
        onClick: () => {
          axios.post("http://localhost:3001/documents", { title: "Untitled Document" })
      ...
      { label: "Open", onClick: () => navigate("/") },
      {
        ...
        onClick: () => {
          ...
          if (newName) {
            axios.put(`http://localhost:3001/documents/${documentId}`, { title: newName })
